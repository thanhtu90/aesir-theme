    ...
    <div class="grid grid-cols-3 items-center h-[45px] justify-center border-b border-black bg-white">
        ...
        <div class="flex items-center justify-end gap-0">
            ...
            <?php if ( function_exists( 'wc_get_cart_url' ) && function_exists( 'WC' ) && WC()->cart ) : ?>
                <a href="<?php echo esc_url( wc_get_cart_url() ); ?>" class="header-cart-link relative inline-flex items-center justify-center p-2 text-black no-underline hover:opacity-70 transition-opacity" aria-label="<?php esc_attr_e( 'View cart', 'aesir' ); ?>">
